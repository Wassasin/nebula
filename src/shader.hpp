...
X(glm::vec2, gl::uniform_2fv (id, 1, &v[0]));
X(glm::vec3, gl::uniform_3fv (id, 1, &v[0]));
X(glm::vec4, gl::uniform_4fv (id, 1, &v[0]));
X(glm::ivec2, gl::uniform_2iv (id, 1, &v[0]));
X(glm::ivec3, gl::uniform_3iv (id, 1, &v[0]));
X(glm::ivec4, gl::uniform_4iv (id, 1, &v[0]));
X(glm::uvec2, gl::uniform_2uiv(id, 1, &v[0]));
